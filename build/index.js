    ...
    if (safe_not_equal(value, new_value)) {
      ...
      if (stop) {
        ...
        for (let i = 0; i < subscribers.length; i += 1) {
          ...
          s22[1]();
          subscriber_queue.push(s22, value);
        }
        if (run_queue) {
...
var template = ({ head, body }) => '<!DOCTYPE html>\n<html lang="en">\n	<head>\n		<meta charset="utf-8" />\n		<link rel="icon" href="/favicon.png" />\n		<meta name="viewport" content="width=device-width, initial-scale=1" />\n		' + head + '\n	</head>\n	<body class="w-full bg-white text-gray-700">\n		<div id="svelte">' + body + "</div>\n	</body>\n</html>\n";
var options = null;
...
function init(settings = default_settings) {
  ...
  options = {
    ...
    dev: false,
    entry: {
      file: "/./_app/start-c12bb585.js",
      css: ["/./_app/assets/start-0826e215.css"],
      js: ["/./_app/start-c12bb585.js", "/./_app/chunks/vendor-c05afa41.js"]
    },
    fetched: void 0,
    floc: false,
...
var manifest = {
  ...
  routes: [
    ...
    },
    {
      ...
      a: ["src/routes/__layout.svelte", "src/routes/blog/[uid].svelte"],
      b: [".svelte-kit/build/components/error.svelte"]
    },
    {
      type: "endpoint",
      pattern: /^\/api\/blog\/articles\.json$/,
      params: empty,
...
var module_lookup = {
  ...
  "src/routes/blog/[uid].svelte": () => Promise.resolve().then(function() {
    return _uid_;
  })
};
var metadata_lookup = { "src/routes/__layout.svelte": { "entry": "/./_app/pages/__layout.svelte-981eca61.js", "css": ["/./_app/assets/pages/__layout.svelte-7c7b09fc.css"], "js": ["/./_app/pages/__layout.svelte-981eca61.js", "/./_app/chunks/vendor-c05afa41.js"], "styles": null }, ".svelte-kit/build/components/error.svelte": { "entry": "/./_app/error.svelte-ad82cbaf.js", "css": [], "js": ["/./_app/error.svelte-ad82cbaf.js", "/./_app/chunks/vendor-c05afa41.js"], "styles": null }, "src/routes/index.svelte": { "entry": "/./_app/pages/index.svelte-0aac5587.js", "css": [], "js": ["/./_app/pages/index.svelte-0aac5587.js", "/./_app/chunks/vendor-c05afa41.js"], "styles": null }, "src/routes/blog/[uid].svelte": { "entry": "/./_app/pages/blog/[uid].svelte-b9ca0aea.js", "css": ["/./_app/assets/pages/blog/[uid].svelte-3898185e.css"], "js": ["/./_app/pages/blog/[uid].svelte-b9ca0aea.js", "/./_app/chunks/vendor-c05afa41.js"], "styles": null } };
...
function render(request, {
  ...
  return respond(__spreadProps(__spreadValues({}, request), { host: host2 }), options, { prerender: prerender2 });
}
var Client = Prismic.client("https://social-images-blog-test.cdn.prismic.io/api/v2", {
  accessToken: "MC5ZTlc4bmhJQUFDQUFoZHFt.LkXvv73vv70477-977-9Xxdz77-977-9EAVL77-977-977-9KjQ977-977-9MQkYCnwG77-9elg"
});
var { Predicates } = Prismic;
async function get$1() {
  const response = await Client.query(Predicates.at("document.type", "article"));
  const result = response.results.map((r) => {
    return __spreadProps(__spreadValues({}, r.data), {
      id: r.id,
      href: r.href,
      uid: r.uid,
  ...
  const { featured, articles } = result == null ? void 0 : result.reduce((acc, current) => {
    if (current.featured) {
...
var articles_json = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  [Symbol.toStringTag]: "Module",
  get: get$1
});
cloudinary.v2.config({
  cloud_name: "VITE_CLOUDINARY_CLOUD_NAME=matiasfha"
});
...
async function get({ params }) {
  ...
  return {
    body: __spreadProps(__spreadValues({}, response.data), {
      id: response.id,
      href: response.href,
      uid: response.uid,
      ogImage: await getOgImage({
        cloudName: {}.VITE_CLOUDINAARY_CLOUD_NAME,
...
var _layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<header class="${"w-full h-32 py-8 px-4 border-b border-solid border-gray-300"}"><div class="${"mx-auto max-w-6xl"}"><h1 class="${"h-14 font-bold text-3xl text-left"}">Your brand</h1>

		<nav class="${"w-full sticky"}"><ul class="${"list-none h-9 flex flex-row items-center justify-items-start"}"><li class="${"pr-4"}"><a href="${"/"}">Home</a></li>
				<li class="${"px-4"}">Blog</li>
				<li class="${"px-4"}">About</li></ul></nav></div></header>
<main class="${"py-2"}">${slots.default ? slots.default({}) : ``}</main>
<footer class="${"h-80"}"><section class="${"h-72 bg-gray-100"}"><div class="${"grid grid-cols-2 gap-12 mx-auto max-w-6xl pt-24"}"><div class="${"flex flex-col items-start justify-between"}"><h2 class="${"text-xl text-gray-900 font-bold"}">Subscribe to the newsletter</h2>
				<p class="${"text-base text-gray-400"}">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Perferendis aspernatur ut at
					quae omnis pariatur obcaecati possimus nisi ea iste!
				</p></div>
			<div class="${"flex items-center justify-around"}"><input type="${"email"}" placeholder="${"Enter your email"}" class="${"h-12 px-5 rounded-3xl shadow-md text-base text-gray-800 w-96"}">
				<button class="${"px-2 flex flex-row justify-around items-center  rounded-3xl bg-gray-900 text-white h-12 w-24 hover:bg-gray-700 hover: animate-pulse"}">Submit
					<svg xmlns="${"http://www.w3.org/2000/svg"}" class="${"h-6 w-6"}" fill="${"none"}" viewBox="${"0 0 24 24"}" stroke="${"currentColor"}"><path stroke-linecap="${"round"}" stroke-linejoin="${"round"}" stroke-width="${"2"}" d="${"M13 5l7 7-7 7M5 5l7 7-7 7"}"></path></svg></button></div></div></section>
	<section class="${"text-center py-2 text-sm"}">Copyright \xA92021 All rights reserved | This template is made with by Me \u2764\uFE0F
	</section></footer>`;
});
...
var ArticleCard = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<article class="${"flex flex-row items-center justify-between transform duration-150 hover:shadow-md"}"><a${add_attribute("href", `/blog/${article.uid}`, 0)}><img class="${"object-scale-down w-28 h-28"}"${add_attribute("src", article.image.url, 0)}${add_attribute("alt", PrismicDOM.RichText.asText(article.title), 0)}></a>
	<div class="${"flex flex-col ml-4 items-start justify-around"}"><a${add_attribute("href", `/blog/${article.uid}`, 0)}><h1 class="${"text-gray-900 text-base mt-4"}">${escape(PrismicDOM.RichText.asText(article.title))}</h1></a>
		<span class="${"text-gray-500 text-sm"}">${escape(date)}</span></div></article>`;
});
...
function load$1({ fetch: fetch2 }) {
  return __awaiter$1(this, void 0, void 0, function* () {
    ...
    const { articles, featured } = yield res.json();
    if (res.ok) {
      return {
        status: res.status,
...
var Routes = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let { articles } = $$props;
  let { featured } = $$props;
  const list2 = [...articles].splice(1, articles.length);
  ...
  return `<section class="${"w-full"}"><div class="${"container max-w-6xl py-12 mx-auto"}"><article class="${"grid grid-cols-2 gap-4"}"><div><a${add_attribute("href", `/blog/${featured.uid}`, 0)}><img${add_attribute("alt", PrismicDOM.RichText.asText(featured.title), 0)}${add_attribute("src", featured.image.url, 0)} class="${"bg-contain object-contain shadow-sm"}"></a></div>
			<div><h2 class="${"text-sm uppercase text-gray-600"}">Editor&#39;s Pick</h2>
				<a${add_attribute("href", `/blog/${featured.uid}`, 0)}><h1 class="${"text-3xl text-gray-900"}">${escape(PrismicDOM.RichText.asText(featured.title))}</h1></a>
				<p class="${"text-base text-gray-800"}">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Voluptate vero obcaecati natus
...
<section class="${"w-full py-8"}"><div class="${"container max-w-6xl py-12 mx-auto"}"><div class="${"grid grid-cols-3 gap-8"}"><article class="${"flex flex-col"}"><a${add_attribute("href", `/blog/${listHeader.uid}`, 0)}><img${add_attribute("alt", PrismicDOM.RichText.asText(listHeader.title), 0)}${add_attribute("src", listHeader.image.url, 0)} class="${"m-0 pb-4 w-full h-52 object-fill"}"></a>
				<a${add_attribute("href", `/blog/${listHeader.uid}`, 0)}><h1 class="${"text-gray-900 text-xl mb-4"}">${escape(PrismicDOM.RichText.asText(listHeader.title))}</h1>
				</a>s
				<p class="${"text-sm text-gray-800"}">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Voluptate vero obcaecati natus
					adipisci necessitatibus eius, enim vel sit ad reiciendis. Enim praesentium magni delectus
					cum, tempore deserunt aliquid quaerat culpa nemo veritatis, iste adipisci excepturi
					consectetur doloribus aliquam accusantium beatae?
				</p></article>
			
			<section>${each(list2, (article) => `${validate_component(ArticleCard, "ArticleCard").$$render($$result, { article }, {}, {})}`)}</section>
			<div class="${"flex flex-col gap-4"}"><h1 class="${"text-base text-gray-800"}">Featured</h1>
				<ul class="${"list-none flex flex-col m-0 gap-8"}"><li class="${"flex flex-row gap-4"}"><span class="${"text-3xl text-gray-400"}">01</span>
						<div class="${"w-full flex flex-col items-start"}"><h2 class="${"text-base text-gray-900"}">News Needs to Meet Its Audiences Whey They Are
							</h2>
							<span class="${"text-sm text-gray-400"}">Jun 19, 2021</span></div></li>
					<li class="${"flex flex-row gap-4"}"><span class="${"text-3xl text-gray-400"}">02</span>
						<div class="${"w-full flex flex-col items-start"}"><h2 class="${"text-base text-gray-900"}">News Needs to Meet Its Audiences Whey They Are
							</h2>
							<span class="${"text-sm text-gray-400"}">Jun 19, 2021</span></div></li></ul></div></div></div></section>`;
});
...
var Seo = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${$$result.head += `${$$result.title = `<title>${escape(title)}</title>`, ""}<meta name="${"robots"}" content="${"index, follow"}" data-svelte="svelte-1ueu43n"><meta name="${"googlebot"}" content="${"index,follow"}" data-svelte="svelte-1ueu43n">${description ? `<meta name="${"description"}"${add_attribute("content", description, 0)} data-svelte="svelte-1ueu43n">` : ``}${canonical ? `<link rel="${"canonial"}"${add_attribute("href", canonical, 0)} data-svelte="svelte-1ueu43n">` : ``}<meta name="${"keywords"}"${add_attribute("content", keywords, 0)} data-svelte="svelte-1ueu43n"><meta property="${"og:title"}"${add_attribute("content", title, 0)} data-svelte="svelte-1ueu43n">${description ? `<meta property="${"og:description"}"${add_attribute("content", description, 0)} data-svelte="svelte-1ueu43n">` : ``}${canonical ? `<meta property="${"og:url"}"${add_attribute("content", canonical, 0)} data-svelte="svelte-1ueu43n">` : ``}<meta property="${"og:type"}"${add_attribute("content", type ? type : "site", 0)} data-svelte="svelte-1ueu43n"><meta property="${"og:image"}"${add_attribute("content", image, 0)} data-svelte="svelte-1ueu43n"><meta name="${"twitter:card"}" content="${"summary_large_image"}" data-svelte="svelte-1ueu43n"><meta name="${"twitter:title"}"${add_attribute("content", title, 0)} data-svelte="svelte-1ueu43n">${description ? `<meta name="${"twitter:description"}"${add_attribute("content", description, 0)} data-svelte="svelte-1ueu43n">` : ``}<meta name="${"twitter:image"}"${add_attribute("content", image, 0)} data-svelte="svelte-1ueu43n">`, ""}`;
});
var css = {
...
var ssr = true;
var prerender = true;
function load({ fetch: fetch2, page }) {
  return __awaiter(this, void 0, void 0, function* () {
    const { uid } = page.params;
    const url = `/api/blog/${uid}.json`;
    const res = yield fetch2(url);
    const article = yield res.json();
    if (res.ok) {
      return { status: res.status, props: { article } };
    }
    return {
      status: res.status,
      error: new Error(`Could not load ${url}, status: ${res.status}`)
...
<main class="${"w-full pb-4"}"><header class="${"post-header w-full bg-gray-900 flex items-start flex-col justify-center relative max-h-96 h-96 svelte-11j33vu"}"><img${add_attribute("src", article.image.url, 0)} class="${"object-cover w-full absolute top-0 left-0 z-0 max-h-96 filter blur-sm"}"${add_attribute("alt", title, 0)}>
		<h1 class="${"text-center text-gray-100 font-bold text-3xl max-w-4xl z-10 p-8"}">${escape(title)}</h1></header>
	<article class="${"text-gray-800 text-base text-left py-12 mx-auto container max-w-6xl "}"><!-- HTML_TAG_START -->${PrismicDOM.RichText.asHtml(article.content)}<!-- HTML_TAG_END --></article>
</main>`;
});
